...
if [ -d $1 ]; then
  ...
  bench/format_sar_output.awk $1"ejb_server"
  gzip -9 $1"db_server" &
  gzip -9 $1"web_server" &
  ...
  echo plot '"'$1db_server.cpu.idle.dat'"' title '"'Database'"' with lines, '"'$1web_server.cpu.idle.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server.cpu.idle.dat'"' title '"'Servlets'"' with lines , '"'$1ejb_server.cpu.idle.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  ...
  echo "set yrange [0:100]" >> $tmpFile;
  echo plot '"'$1db_server.cpu.busy.dat'"' title '"'Database'"' with lines, '"'$1web_server.cpu.busy.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server.cpu.busy.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server.cpu.busy.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server.proc.dat'"' title '"'Database'"' with lines, '"'$1web_server.proc.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server.proc.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server.proc.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server.ctxsw.dat'"' title '"'Database'"' with lines, '"'$1web_server.ctxsw.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server.ctxsw.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server.ctxsw.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server.disk.tps.dat'"' title '"'Database'"' with lines, '"'$1web_server.disk.tps.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server.disk.tps.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server.disk.tps.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server.disk.rtps.dat'"' title '"'Database read'"' with lines, '"'$1db_server.disk.wtps.dat'"' title '"'Database write'"' with lines, '"'$1web_server.disk.rtps.dat'"' title '"'Frontend read'"' with lines, '"'$1web_server.disk.wtps.dat'"' title '"'Frontend write'"' with lines, '"'$1servlets_server.disk.rtps.dat'"' title '"'Servlets read'"' with lines, '"'$1servlets_server.disk.wtps.dat'"' title '"'Servlets write'"' with lines, '"'$1ejb_server.disk.rtps.dat'"' title '"'EJB read'"' with lines, '"'$1ejb_server.disk.wtps.dat'"' title '"'EJB write'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server.disk.brdps.dat'"' title '"'Database read'"' with lines, '"'$1db_server.disk.bwrps.dat'"' title '"'Database write'"' with lines, '"'$1web_server.disk.brdps.dat'"' title '"'Frontend read'"' with lines, '"'$1web_server.disk.bwrps.dat'"' title '"'Frontend write'"' with lines, '"'$1servlets_server.disk.brdps.dat'"' title '"'Servlets read'"' with lines, '"'$1servlets_server.disk.bwrps.dat'"' title '"'Servlets write'"' with lines, '"'$1ejb_server.disk.brdps.dat'"' title '"'EJB read'"' with lines, '"'$1ejb_server.disk.bwrps.dat'"' title '"'EJB write'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server.mem.kbmemused.dat'"' title '"'Database'"' with lines, '"'$1web_server.mem.kbmemused.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server.mem.kbmemused.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server.mem.kbmemused.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Amount of memory in KB"' >> $tmpFile;
  echo plot '"'$1db_server.mem.kbmemused.dat'"' title '"'Database memory'"' with lines, '"'$1web_server.mem.kbmemused.dat'"' title '"'Frontend memory'"' with lines, '"'$1servlets_server.mem.kbmemused.dat'"' title '"'Servlets memory'"' with lines, '"'$1ejb_server.mem.kbmemused.dat'"' title '"'EJB memory'"' with lines, '"'$1db_server.mem.kbcached.dat'"' title '"'Database cache'"' with lines, '"'$1web_server.mem.kbcached.dat'"' title '"'Frontend cache'"' with lines, '"'$1servlets_server.mem.kbcached.dat'"' title '"'Servlets cache'"' with lines, '"'$1ejb_server.mem.kbcached.dat'"' title '"'EJB cache'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server.net.rxpck.dat'"' title '"'Database received'"' with lines, '"'$1db_server.net.txpck.dat'"' title '"'Database transmitted'"' with lines, '"'$1web_server.net.rxpck.dat'"' title '"'Frontend received'"' with lines, '"'$1web_server.net.txpck.dat'"' title '"'Frontend transmitted'"' with lines, '"'$1servlets_server.net.rxpck.dat'"' title '"'Servlets received'"' with lines, '"'$1servlets_server.net.txpck.dat'"' title '"'Servlets transmitted'"' with lines, '"'$1ejb_server.net.rxpck.dat'"' title '"'EJB received'"' with lines, '"'$1ejb_server.net.txpck.dat'"' title '"'EJB transmitted'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server.net.rxbyt.dat'"' title '"'Database received'"' with lines, '"'$1db_server.net.txbyt.dat'"' title '"'Database transmitted'"' with lines, '"'$1web_server.net.rxbyt.dat'"' title '"'Frontend received'"' with lines, '"'$1web_server.net.txbyt.dat'"' title '"'Frontend transmitted'"' with lines, '"'$1servlets_server.net.rxbyt.dat'"' title '"'Servlets received'"' with lines, '"'$1servlets_server.net.txbyt.dat'"' title '"'Servlets transmitted'"' with lines, '"'$1ejb_server.net.rxbyt.dat'"' title '"'EJB received'"' with lines, '"'$1ejb_server.net.txbyt.dat'"' title '"'EJB transmitted'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server.sock.totsck.dat'"' title '"'Database'"' with lines, '"'$1web_server.sock.totsck.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server.sock.totsck.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server.sock.totsck.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
